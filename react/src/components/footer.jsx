export default (props) => {
  ...
  return (
    <div className="container mx-auto p-4 text-center flex flex-col gap-3">
      <ul className="flex flex-row gap-5 justify-center text-slate-200 border-t-2 rounded-xl shadow w-48 p-3 mx-auto animate-bounce">
      ...
      <span>
        ©
        <a
          href={footerData.explanation.url}
          rel="nofollow"
          target="_blank"
          title="Designed by EW"
          className=" hover:text-slate-500 hover:underline duration-200"
        >
          {footerData.explanation.title}
        </a>{" "}
